...
* `img_features`: precomputed image embeddings computed by ResNet-152 (provided by courtesy of the [Matterport3D simulator](https://github.com/peteanderson80/Matterport3DSimulator)). 
