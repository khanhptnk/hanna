...
Training and testing our models only require downloading the `house_segmentations` portion of the dataset. Unzip the files so that `$MATTERPORT_DATA_DIR/v1/scans/<scanId>/house_segmentations/panorama_to_region.txt` are present. 
